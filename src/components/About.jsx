    ...
    <section className="w-full bg-cream pt-16 md:pt-24 pb-24 md:pb-36 px-6">
      <div className="max-w-6xl mx-auto flex flex-col lg:flex-row items-center justify-center gap-12 lg:gap-24">
        ...
        <div className="w-full lg:w-1/2 flex flex-col items-center lg:items-start text-dark-teal">
          ...
          <p className="text-sm md:text-base lg:text-xl font-regular leading-relaxed max-w-[320px] md:max-w-[450px] text-dark-teal/80 text-justify lg:text-left">
            Found brings personalized, opportunities, pathways, and student insights together in one place—so you can spend less time searching and more time moving forward.
          </p>
        </div>
